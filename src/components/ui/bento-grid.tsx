  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
        ...
        <p className="max-w-lg text-neutral-400 dark:text-neutral-200">
          {description}
        </p>
      </div>
...
// Flexible bento tile that accepts arbitrary children — used for testimonials,
// stats, and custom-composed sections in generated sites.
const BentoTile = ({
  children,
  className,
}: {
  ...
  return (
    <div
      className={cn(
        "group relative col-span-3 flex flex-col overflow-hidden rounded-xl p-6",
        "bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]",
        "transform-gpu dark:bg-black dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
        className
      )}
